...
public class GuideSpirituel extends CarteAction {
	...
	private static final String[][] dogmeGuideSpirituels = { { "Humain", "Nature" }, { "Symboles", "Humain" },
			...
			{ "Nature", "Humain" }, { "Nature", "Symboles" }, { "Chaos", "Humain" }, { "Humain", "Mystique" },
	...
	public static final String[] CapaGuideSpirituel = { "Equivalent à la pose d'une carte Apocalyps.",
			"Equivalent à la pose d'une carte Apocalypse.", "Equivalent à la pose d'une carte Apocalypse.",
			"Fait gagner un nombre de points d'Action égal au nombre de cartes de Croyants rattachées. L'Origine des points d'Action est au choix du joueur.",
			"Fait gagner un nombre de points d'Action égal au nombre de cartes de Croyants rattachées. L'Origine des points d'Action est au choix du joueur.",
			"Fait gagner un nombre de points d'Action égal au nombre de cartes de Croyants rattachées. L'Origine des points d'Action est au choix du joueur.",
			"Fait gagner un nombre de points d'Action égal au nombre de cartes de Croyants rattachées. L'Origine des points d'Action est au choix du joueur.",
			"Fait gagner un nombre de points d'Action égal au nombre de cartes de Croyants rattachées. L'Origine des points d'Action est au choix du joueur.",
			...
			"Echangez l'un de vos Guides Spirituels avec un d'une autre Divinité. Vous choisissez les deux guides Spirituels en question. Les Croyants restent attachés aux mêmes cartes.",
