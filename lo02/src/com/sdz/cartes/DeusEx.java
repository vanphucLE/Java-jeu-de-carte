...
public class DeusEx extends CarteAction {
	...
	private static final String[] origineDeusEx = { "Jour", "Nuit", "Jour", "Jour", "Nuit", "Nuit", "Néant", "Néant",
			"Néant", "", "", "", "", "", "", "", "", "" };

	public static final String[] CapaDeusEx = {
			...
			"Annule la capacité spéciale d'une carte d'Action d'Origine Jour ou Nuit.",
			"Annule la capacité spéciale d'une autre carte d'Action.",
			"Annule la capacité spéciale d'une autre carte d'Action.",
			...
			"Relancez le dé de Cosmogonie. Le tour de jeu se terminera normalement, mais sous la nouvelle influence.",
			"Choisissez un des Guides Spirituels d'un autre joueur, et l'un des votres. Lancez le dé de Cosmogonie. Sur Jour, le Guide adverse est sacrifié, sur Nuit le votre est sacrifié, sur Néant rien ne se passe. Les" };
